...
def get_data(data_batch):
    ...
    data_file = train_dir_rgb + data_batch
    # print('datafile', data_file)
    save_file = save_dir_train_rgb + data_batch
    ...
    # forward
    multi_g1, matt1  = multihead_attention(queries=group1, keys=group1, num_units=n_hidden, num_heads=128,dropout_rate=0.9,is_training=1,causality=True, scope = 'forward', reuse = tf.AUTO_REUSE)
    # backward
    multi_g2, matt2  = multihead_attention(queries=group1[:,::-1,:] , keys=group1[:,::-1,:] , num_units=n_hidden, num_heads=128,dropout_rate=0.9,is_training=1,causality=True, scope = 'backward', reuse = tf.AUTO_REUSE)
...
def parse_args():
    ...
    parser.add_argument('--num_workers',default=8,type=int,help='num of workers to act multi-process')
...
if __name__ =='__main__':
    ...
    train_dir_rgb = '/media/senilab/DATA2/feature_hmdb_i3d_128/train_rgb/'
    train_dir_flow = '/media/senilab/DATA2/feature_hmdb_i3d_128/train_flow/'
    #train_dir_dp = '/media/senilab/DATA2/feature_hmdb_i3d_5c_64_seni/train_dp/'
    test_dir_rgb = '/media/senilab/DATA2/feature_hmdb_i3d_128/test_rgb/'
    test_dir_flow = '/media/senilab/DATA2/feature_hmdb_i3d_128/test_flow/'
    #test_dir_dp = '/media/senilab/DATA2/feature_hmdb_i3d_5c_64_seni/test_dp/'

    save_dir_train_rgb = '/media/senilab/DATA2/new_feature_att_hmdb_128/train_rgb/'
    save_dir_test_rgb = '/media/senilab/DATA2/new_feature_att_hmdb_128/test_rgb/'
    save_dir_train_flow = '/media/senilab/DATA2/new_feature_att_hmdb_128/train_flow/'
    save_dir_test_flow = '/media/senilab/DATA2/new_feature_att_hmdb_128/test_flow/'
    #save_dir_train_dp = '/media/senilab/DATA2/new_feature_att_hmdb_128/train_dp/'
    #save_dir_test_dp = '/media/senilab/DATA2/new_feature_att_hmdb/test_dp/'
    ...
    list_sisa = sorted([f for f in listdir(save_dir_train_rgb) if isfile(join(save_dir_train_rgb, f))])

    list_error = ['The_Scarlet_Pimpernel_-_duel_fencing_u_cm_np2_fr_med_0']
    
    list_sisa_train = np.setdiff1d(list_train_rgb, list_sisa)
    # list_sisa_train= list_error
