...
import sys
sys.path.insert(1,'/media/senilab/DATA/Master/I3D-Tensorflow/')
import input_data
import math
import numpy as np
...
FLAGS = flags.FLAGS
model_save_dir = '/home/senilab/Documents/I3D/models/flow_imagenet_30000_51_4_64_0.0001_decay'
...
def run_training():
    ...
    flow_pre_model_save_dir = "/home/senilab/Documents/I3D/checkpoints/flow_imagenet_hmdb"
    ...
    train_writer = tf.summary.FileWriter('/home/senilab/Documents/I3D/visual_logs/train_flow_imagenet_30000_51_4_64_0.0001_decay', sess.graph)
    test_writer = tf.summary.FileWriter('/home/senilab/Documents/I3D/visual_logs/test_flow_imagenet_30000_51_4_64_0.0001_decay', sess.graph)
