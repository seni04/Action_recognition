...
FLAGS = flags.FLAGS
model_save_dir = '/home/senilab/Documents/I3D/models/openpose_imagenet_30000_51_4_64_0.0001_decay'
...
def run_training():
    ...
    rgb_pre_model_save_dir = "/home/senilab/Documents/I3D/checkpoints/rgb_imagenet"
    ...
    train_writer = tf.summary.FileWriter('/home/senilab/Documents/I3D/visual_logs/train_openpose_imagenet_30000_51_4_64_0.0001_decay', sess.graph)
    test_writer = tf.summary.FileWriter('/home/senilab/Documents/I3D/visual_logs/test_openpose_imagenet_30000_51_4_64_0.0001_decay', sess.graph)
    for step in xrange(FLAGS.max_steps):
        start_time = time.time()
        rgb_train_images, flow_train_images, train_labels, _, _, _ = input_data_op.read_clip_and_label(
                      filename='/media/senilab/DATA/Master/I3D-Tensorflow/list/hmdb_list/train.list',
        ...
        if step % 10 == 0 or (step + 1) == FLAGS.max_steps:
            ...
            rgb_val_images, flow_val_images, val_labels, _, _, _ = input_data_op.read_clip_and_label(
                            filename='/media/senilab/DATA/Master/I3D-Tensorflow/list/hmdb_list/test.list',
                            batch_size=FLAGS.batch_size * gpu_num,
                            num_frames_per_clip=FLAGS.num_frame_per_clib,
                            crop_size=FLAGS.crop_size,
                            shuffle=True
