...
FLAGS = flags.FLAGS
model_save_dir = '/media/senilab/DATA/Master/I3D-Tensorflow/experiments/ucf-101/models/rgb_imagenet_30000_101_5_64_0.0001_decay'
...
def run_training():
    ...
    rgb_pre_model_save_dir = "/media/senilab/DATA/Master/I3D-Tensorflow/checkpoints/rgb_imagenet/"
    ...
    train_writer = tf.summary.FileWriter('/media/senilab/DATA/Master/I3D-Tensorflow/visual_logs/train_rgb_imagenet_101_10000_5_64_0.0001_decay', sess.graph)
    test_writer = tf.summary.FileWriter('/media/senilab/DATA/Master/I3D-Tensorflow/visual_logs/test_rgb_imagenet_101_10000_5_64_0.0001_decay', sess.graph)
