...
flags.DEFINE_integer('classics', 100, 'The num of class')
FLAGS = flags.FLAGS
...
def run_training():
    ...
    pre_model_save_dir = "/media/senilab/DATA/Master/I3D-Tensorflow/experiments/ucf-101/models/rgb_imagenet_10000_4_64_0.0001_decay"
